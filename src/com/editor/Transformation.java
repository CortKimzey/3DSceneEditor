...
public class Transformation extends Box2D
{
    private Input xIn, yIn, zIn;

    public Transformation(int width, int height, int x, int y)
    {
    ...
    public void paint(Graphics g)
    {
        ...
        g.drawString("Translation: ", loc[0] + 15, loc[1] + 15);
        g.drawLine(loc[0] + 5, getTBLR(0), loc[0] + 5, getTBLR(1));
